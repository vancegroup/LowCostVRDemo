...
-- this function is necessary to correct for a bug with either VRPN or the Hydra hardware.
...
Actions.addFrameAction(function()
    repeat
        stickYDown = {["pressed"] = false; ["justPressed"] = false; ["justReleased"] = false; ["justChanged"] = false}
        print("In sticklock frameAction")
