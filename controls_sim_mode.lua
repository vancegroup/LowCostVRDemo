-- Redefines the controls aliases for use in sim mode. See controls.lua. Always require "controls" first, then controls_sim_mode if it is to be used.
...
click_to_delete_button = button2
